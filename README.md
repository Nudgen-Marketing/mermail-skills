...
| `mermail-receipt-clerk` | Find invoice/receipt mail, build a ledger line, optionally pay a user-authorized vendor from Agent Wallet, then draft a receipt email |
