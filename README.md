...
| `mermail-receipt-digest` | Build a bounded receipt and expense ledger from invoices and payment confirmations, with an optional owner-reviewed digest draft |
