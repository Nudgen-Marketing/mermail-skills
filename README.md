...
| `mermail-security-bounty-desk` | Ingest vulnerability disclosures, neutralize exploit/prompt injections, evaluate bug bounty policy, verify treasury, and stage Agent Wallet reward proposals |
