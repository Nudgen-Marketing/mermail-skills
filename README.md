...
| `mermail-deliverability-sentinel` | Run timed OTP deliverability probe rounds against a receiver mailbox, audit sender auth, and seal tamper-evident round records with regression report cards |
