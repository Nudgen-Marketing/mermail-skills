...
| `mermail-invoice-settle` | Extract a vendor invoice from the agent inbox, pay only after owner-authorized Agent Wallet / PayBox terms, and send a same-thread receipt |
