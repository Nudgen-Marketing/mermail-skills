...
| `mermail-inbound-action-gate` | Gate inbound ops behind Action-Gate: draft-only until explicit send approval; destructive via `prepare_destructive_action`; wallet moves only as transfer proposals |
