...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-patchpilot
...
| `mermail-patchpilot` | Turn a selected Mermail software incident into bounded local remediation, deterministic verification, and an evidence-gated resolution reply |
