...
| `mermail-decision-room` | Turn business email threads into evidence-bound decision briefs with facts, conflicts, gaps, options, risks, and a recommended next action; analysis only |
