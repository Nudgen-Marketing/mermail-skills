...
| `mermail-paid-work-verifier` | Run a paid client-work pipeline: extract scope/price, verify claimed payments against Agent Wallet evidence before working, deliver in-thread under owner authorization, and reconcile settlement |
