...
| `mermail-payment-request-agent` | Triage inbound invoice/payment-request email into an owner brief, then hand off one exact PayBox effect only after independent owner authorization |
