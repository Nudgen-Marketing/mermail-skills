...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-agent-handshake
```
...
| `mermail-agent-handshake` | Autonomous email negotiation agent for procurement under a plain-English budget cap, halting before payment |
