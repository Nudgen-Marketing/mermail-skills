...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-scholarship-desk
...
| `mermail-scholarship-desk` | Track scholarship and admissions email on an Application Board, quote and convert deadlines, explain items in the applicant's language, screen fee scams, and draft replies for review |
