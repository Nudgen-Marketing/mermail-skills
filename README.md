...
| `mermail-inbound-risk-triage` | Judge whether inbound mail is safe to trust — payment-redirection and impersonation risk, prompt injection in message content — then quarantine and draft an escalation |
