...
| `mermail-payment-firewall` | Zero-trust gate for emailed payment requests: authenticate provenance, compare amount/asset/chain/destination/purpose with owner policy, and block mismatches before any wallet effect |
