...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-ap-invoice-agent
...
| `mermail-ap-invoice-agent` | Triage vendor invoices, draft owner AP briefs; optional owner-approved PayBox prep |
