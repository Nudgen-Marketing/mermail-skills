...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-vendor-invoice-triage
...
| `mermail-vendor-invoice-triage` | Triage vendor invoices, draft acknowledgments, and organize AP mail (optional user-approved payment handoff) |
