...
| `mermail-contact-keeper` | Build a relationship ledger from mailbox evidence, flag stale threads and open loops, and draft re-engagement follow-ups for approval |
