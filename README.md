...
| `mermail-proof-of-payment` | Verify inbound email payment claims on-chain (recipient, amount, token contract, confirmed status, no replay) before releasing deliverables |
