...
| `mermail-dsar-desk` | GDPR/CCPA DSAR / privacy-rights desk: classify requests, hard identity-pending holds, minimized response drafts, case-state folders, optional user-authorized verify/redact pay |
