...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-receipt-auditor
...
| `mermail-receipt-auditor` | Extract receipts into a local JSONL/CSV spend ledger and answer spend questions (read-only) |
