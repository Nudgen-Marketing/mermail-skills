...
| `mermail-egress-guard` | Authorize outbound effects: sends, replies, forwards, scheduled sends, mailbox forwarding and auto-reply settings, and workspace invitations |
