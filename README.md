...
| `mermail-bounty-scout` | Track bounty wins, sponsor payouts, and hackathon deadlines from an agent inbox; classify mail, build an evidence-backed ledger, draft follow-ups |
