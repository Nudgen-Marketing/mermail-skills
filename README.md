...
npx skills add Nudgen-Marketing/mermail-skills --skill mermail-bounty-desk
...
| `mermail-bounty-desk` | Track bounty-provider email, provider status, payment signals, and safe follow-up drafts |
