...
| `mermail-spend-governor` | Enforce an owner-declared spend policy before a payment leaves the wallet, keep an append-only receipts ledger, reconcile proof versus settlement, detect duplicate charges, and draft spend reports |
