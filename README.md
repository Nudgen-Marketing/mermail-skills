...
| `mermail-invoice-agent` | Audit incoming invoices from email, enforce spend policies and vendor allowlists, coordinate PayBox settlements, and deliver payment receipts |
