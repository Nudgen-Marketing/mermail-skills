...
| `mermail-research-agent` | Customer research engagements with approved delivery |
| `mermail-deliverable-desk` | Scoped client deliverables: Order Card, approved send, receipt |
