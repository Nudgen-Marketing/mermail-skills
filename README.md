...
| `mermail-away-agent` | Cover an inbox while its owner is away: classify against an away brief, draft acknowledgements and brief-grounded answers for one batch approval, hold what needs the owner, escalate by rule, file into away folders, and deliver a return briefing |
