...
| `mermail-dual-control` | Maker-checker payment review: two independent evidence-path derivations, agreement records, and cross-checked payment orders handed to PayBox approval |
