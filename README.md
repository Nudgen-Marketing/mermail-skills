...
| `mermail-agent-security-auditor` | Run an assisted smart contract and wallet security audit service: code analysis, finding categorization, audit report drafting, and x402 payment verification |
