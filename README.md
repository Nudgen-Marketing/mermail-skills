...
| `mermail-obligations-agent` | Register document expiry and invoice due dates from email attachments, escalate reminders, and settle payables only after payee reconciliation |
