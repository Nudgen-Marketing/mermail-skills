...
| `mermail-invoice-settler` | Verify freelance contractor invoices and micro-bounty claims, check deliverable criteria, settle on-chain USDC payments via PayBox, and dispatch cryptographic email receipts |
