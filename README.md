...
| `mermail-paid-research-desk` | Run an unattended paid research desk: triage inbound requests, enforce pay-before-work, deliver cited memos by email, and keep a per-job ledger |
