...
| `mermail-invoice-guard` | Human-in-the-loop vendor invoice payment from inbox; extract untrusted candidates, preview exact payout, pay with PayBox only after user confirms |
