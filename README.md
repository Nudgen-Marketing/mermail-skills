...
| `mermail-receipt-ledger` | Build a receipts/invoices ledger from Mermail mail, file matches, and draft an owner spend digest (optional read-only PayBox context) |
