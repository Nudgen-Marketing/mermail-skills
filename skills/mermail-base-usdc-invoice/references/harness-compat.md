# Harness compatibility / adapter-compliance — mermail-base-usdc-invoice

Harness-audit evidence for cross-harness install of this skill. Complements [harness.md](harness.md) with explicit adapter surfaces (Claude, Codex, OpenCode, Cursor/OpenClaw, Zed, dmux) and expected install paths.
...
See also: [harness.md](harness.md) (narrative per-client notes), [workflows.md](workflows.md) (URI formulas), [ci-failures.md](ci-failures.md) (validate.mjs gates).
