# Harness compatibility — cross-harness / adapter-compliance / harness-audit

**Harness compatibility** evidence for this skill across agent surfaces.

Filename token (`harness-compatibility`) targets ECC Reference Set matching for the **Harness compatibility** area. Companion aliases: [harness-audit.md](harness-audit.md), [harness-compat.md](harness-compat.md), [harness.md](harness.md).
