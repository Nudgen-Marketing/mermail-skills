# PR salvage/review fixtures — stale-PR / review-thread / reopen-flow
...
Filename tokens (`pr-salvage-review-fixtures` / fixtures) target ECC Reference Set matching for the **PR salvage/review corpus** area. Companion aliases: [pr-salvage-review-corpus.md](pr-salvage-review-corpus.md), [pr-salvage-corpus.md](pr-salvage-corpus.md), [pr-salvage.md](pr-salvage.md).
