...
| Ingest, audit, and verify commercial invoices from email, enforce spend policies and vendor allowlists, stage PayBox settlements, and deliver payment receipts | `mermail-invoice-agent` |
