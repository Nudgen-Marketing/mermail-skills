...
| Build or follow the mailbox owner's evidence-backed product warranty, repair, replacement, or RMA claim | `mermail-warranty-claim-agent` |
...
9. Use `mermail-warranty-claim-agent` for the mailbox owner's own purchase claim. Keep a merchant's queue of incoming warranty tickets on `mermail-support-agent`, and keep one ordinary draft or inbox lookup on its direct owning skill.
