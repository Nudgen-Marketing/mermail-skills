...
| Process vendor invoices, verify billing terms against PayBox balances, execute on-chain settlement, and deliver transaction receipts | `mermail-invoice-agent` |
