...
| Run an unattended agent's wake/sleep email heartbeat: catch-up digest since the last wake, one owner briefing send, or arming/cancelling an overdue-wake deadman alert | `mermail-heartbeat` |
