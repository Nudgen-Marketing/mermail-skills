...
| Turn an inbound invoice, receipt, or contract in the agent mailbox into structured JSON by paying a per-document x402 parsing fee, then reply on the same thread with the fields and receipt | `mermail-invoice-inbox-x402` |
