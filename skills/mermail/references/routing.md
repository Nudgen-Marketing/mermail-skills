...
| Scan mailboxes for newsletter and subscription digests, compile a concise time-bounded brief, optionally translate foreign-language newsletters, or organize processed newsletters by label or folder | `mermail-newsletter-brief` |
