...
12. Prefer mermail-agent-handshake when the user wants an autonomous email negotiation agent to negotiate purchases with a vendor under a budget cap, halting before payment.
