...
| Verify sender allowlist, apply amount policy, and resolve billing-inbox invoices to a truthful paid, pending, rejected, or failed status with Agent Wallet / PayBox checks | `mermail-invoice-agent` |
