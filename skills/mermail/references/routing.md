...
| Run an autonomous Solana escrow settlement desk: triage incoming vendor invoices/claims, enforce cryptographic spend limits, execute PayBox Solana USDC transfers, and deliver formal on-chain settlement receipts | `mermail-solana-escrow-desk` |
