...
| Review a selected CSV attachment against user-supplied data rules and prepare candidate records, exceptions, and an unsent summary | `mermail-csv-review-agent` |
