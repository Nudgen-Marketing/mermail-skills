...
| Translate, explain, or draft a fact-locked reply for multilingual email | `mermail-language-bridge` |
...
9. Prefer `mermail-language-bridge` when the user needs multilingual email translated, explained, or answered with a fact lock. Generic reading or composition in the user's current language stays on the owning inbox or compose skill.
