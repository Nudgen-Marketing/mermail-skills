...
| Orchestrate a complete third-party signup end-to-end — plan approval, mailbox identity via the inbox skill, verification-mail extraction, and approved activation — when the user asks the agent to sign up for a service | `mermail-signup-agent` |
