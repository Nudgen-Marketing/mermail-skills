...
| Triage GitHub, CI, dependency, or security notification mail into a digest, draft a reply that posts back to the GitHub thread, organize developer mail, or prepare an explicit bounty payout preview for hand-off | `mermail-dev-inbox` |
