...
| Verify an inbound vendor invoice against the user's vendor allowlist, flag invoice fraud signals, and prepare one exact approved Agent Wallet transfer | `mermail-invoice-payments` |
