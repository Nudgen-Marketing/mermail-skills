...
| Triage API outages, webhook failures, provider alerts, signature errors, rate limits, or integration regressions into an evidence-linked incident timeline | `mermail-api-incident-agent` |
