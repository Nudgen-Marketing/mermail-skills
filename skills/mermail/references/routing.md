...
| Fulfill a paid file order emailed by a customer (order email with attachment, deterministic fulfillment script, delivery reply with payment terms) | `mermail-order-desk` |
