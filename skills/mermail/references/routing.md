...
| Audit a mailbox for receipts/renewals, build a subscription ledger, detect price changes, or draft cancellation mail (never send) | `mermail-subscription-auditor` |
