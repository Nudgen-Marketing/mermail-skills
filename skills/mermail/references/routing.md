...
| Run an unattended paid research desk on a Mermail mailbox: triage inbound requests, enforce pay-before-work, deliver cited memos by email, and keep a per-job ledger | `mermail-paid-research-desk` |
