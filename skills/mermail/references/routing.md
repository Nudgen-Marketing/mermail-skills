...
| Ingest bounty or contractor milestone deliverables, verify proofs, formulate bounded PayBox payout previews, require explicit human confirmation, and dispatch verifiable email receipts | `mermail-bounty-settler` |
