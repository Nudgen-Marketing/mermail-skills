...
| Verify an inbound invoice or payment-request email against paid history, screen it for address-swap or lookalike-sender fraud, and hold a wallet transfer proposal for human approval without ever paying | `mermail-invoice-guard` |
