...
| Delegate one bounded task to a second AI agent through a user-approved Mermail mailbox, track its tagged reply, verify its result envelope, and integrate the outcome | `mermail-relay-agent` |
