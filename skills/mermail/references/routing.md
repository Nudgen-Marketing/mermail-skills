...
| Analyze an outage, security event, service degradation, or operational alert and prepare a source-linked incident brief or unsent status-update draft | `mermail-incident-brief-agent` |
